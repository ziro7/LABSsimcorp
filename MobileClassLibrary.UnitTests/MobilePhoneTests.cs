...
namespace MobileClassLibrary.UnitTests {
    ...
    public class MobilePhoneTests {
        ...
        User thomas = new User(2, "Thomas", 12341235);
        ...
        public void PrintWithFilter_UserFilterEnabled_OnlySelectedUser() {
            ...
            MobilePhone mobile = new MobilePhone(Model.Iphone8, output);
            ...
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(jacob, "testMessage from Jacob", DateTime.Now)));
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(thomas, "testMessage from Thomas", DateTime.Now)));
        ...
        public void PrintWithFilter_UserFilterEnabled_OnlySelectedDate() {
            ...
            mobile.ChangeFormat(OutputFormat.FormatToUpper);
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(jacob, "testMessage from Jacob", DateTime.Now)));
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(thomas, "testMessage from Thomas", DateTime.Now.Add(new TimeSpan ( 3,0,0)))));
            mobile.ViewMessages(fakeForm.FilterDict, filterValueDTO);
        ...
        public void PrintWithFilter_UserFilterEnabled_AllSelected() {
            ...
            //act
            mobile.ChangeFormat(OutputFormat.FormatToUpper);
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(jacob, "testMessage3 from Jacob", DateTime.Now)));
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(thomas, "testMessage3 from Thomas", DateTime.Now.Add(new TimeSpan(0, 1, 0)))));
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(jacob, "testMessage from Jacob", DateTime.Now.Add(new TimeSpan(0, 2, 0)))));
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(thomas, "testMessage from Thomas", DateTime.Now.Add(new TimeSpan(0, 3, 0)))));
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(thomas, "testMessage from Thomas", DateTime.Now.Add(new TimeSpan(0, 4, 0)))));
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(thomas, "testMessage from Thomas", DateTime.Now.Add(new TimeSpan(1, 1, 0)))));
            mobile.SMSReceivedHandler(this, new MessageEventArgs(new Message(jacob, "testMessage3 from Jacob", DateTime.Now.Add(new TimeSpan(1, 1, 0)))));
            mobile.ViewMessages(fakeForm.FilterDict, filterValueDTO);
